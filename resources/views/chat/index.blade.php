...
<body class="bg-gray-100 flex items-center justify-center overflow-hidden" style="height: 100dvh;">

<div class="w-full max-w-6xl h-dvh md:h-[90vh] bg-white md:rounded-2xl shadow-lg flex overflow-hidden relative">

    {{-- SIDEBAR --}}
    <div id="sidebar" class="w-full md:w-80 md:min-w-80 border-r border-gray-200 flex flex-col bg-white absolute md:relative inset-0 z-10 h-full max-h-full overflow-hidden
    {{ isset($conversation) ? 'hidden md:flex' : 'flex' }}">
        ...
        {{-- Info User Login --}}
        <div class="p-3 border-t border-gray-200 flex items-center gap-3 bg-gray-50 flex-shrink-0">
    ...
    {{-- MAIN CHAT AREA --}}
    <div id="chatArea" class="flex-1 flex-col absolute md:relative inset-0 z-20 bg-white h-full
    {{ isset($conversation) ? 'flex' : 'hidden md:flex' }}">
        ...
        @isset($conversation)
            ...
            {{-- Input Pesan --}}
            <div class="px-4 py-3 border-t border-gray-200 bg-white" style="padding-bottom: max(12px, env(safe-area-inset-bottom));">
        ...
        @else
            ...
            <div class="flex-1 hidden md:flex flex-col items-center justify-center text-gray-400">
...
<div id="modalPrivate" class="hidden fixed inset-0 bg-black/50 flex items-center justify-center z-50 px-4">
...
<div id="modalGroup" class="hidden fixed inset-0 bg-black/50 flex items-center justify-center z-50 px-4">
    <div class="bg-white rounded-2xl p-6 w-full max-w-sm shadow-xl">
